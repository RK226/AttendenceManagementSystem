...
namespace BusinessServices.BusinessServices
{
    public class SectionServices : ISectionServices
    {
        ...
        public SectionServices(UnitOfWork unitOfWork)
        {
        ...
        {
            var sections = _context.SectionMasters.ToList();
            List<SectionEntity> lstSection = Mapping(sections);
            return lstSection;
        }
